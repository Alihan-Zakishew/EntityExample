...
namespace EntityExample {
    ...
    public partial class localDbDataSet : global::System.Data.DataSet {
        ...
        public partial class CityDataTable : global::System.Data.TypedTableBase<CityRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CityRow AddCityRow(string name, string population, string country) {
            ...
            public string population {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'population\' в таблице \'City\' равно DBNull.", e);
                    }
                }
                set {
...
namespace EntityExample.localDbDataSetTableAdapters {
    ...
    public partial class CityTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[City] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_population = 1 AND [population] IS NULL) OR ([population] = @Original_population)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[City] ([name], [population], [country]) VALUES (@name, @popula" +
                "tion, @country);\r\nSELECT Id, name, population, country FROM City WHERE (Id = SCO" +
                "PE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[City] SET [name] = @name, [population] = @population, [country] = @country WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_population = 1 AND [population] IS NULL) OR ([population] = @Original_population)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)));
SELECT Id, name, population, country FROM City WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EntityExample.Properties.Settings.Default.localDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, population, country FROM dbo.City";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_population, string Original_country) {
        ...
        public virtual int Insert(string name, string population, string country) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string population, string country, int Original_Id, string Original_name, string Original_population, string Original_country, int Id) {
            if ((name == null)) {
            ...
            if ((Original_population == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_population));
            }
            if ((Original_country == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string population, string country, int Original_Id, string Original_name, string Original_population, string Original_country) {
            return this.Update(name, population, country, Original_Id, Original_name, Original_population, Original_country, Original_Id);
        }
    }
